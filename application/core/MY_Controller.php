...
//This controller is responsible for setting up the assets for each page.
	...
	function __construct() {
		...
		$this->assetor->load('ol/ol.css', 'CSS_MAPS');
		...
		$this->assetor->load('maps/ol.js', 'JS_Maps');
		$this->assetor->load('maps/map.js', 'JS_Maps');
		...
		$this->StyleData['CSS_MAPS']      = $this->assetor->generate('CSS_MAPS');
