...
<div class="col-md-6">
    ...
    <?php }?>
	<?php if($dbname == 'sediment') {?>
	<h1><?php echo"<a href='".base_url("assets/samples/BYU_Bedload_Data_v1.1.xlsx")."'><font color='red'><img src='".base_url("assets/images/excel-icon.png")."' style='width:50px;height:50px;' align='left'>DOWNLOAD THE BEDLOAD DATABASE HERE AS AN EXCEL FILE</a></font>";?><h1>
	<?php }?>
</div>
