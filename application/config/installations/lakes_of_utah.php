<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['database_name']    = 'lakes_of_utah';
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'BYU Civil and Environmental Engineering'; //Name of your blog/Website homepage.
    $config['homelink'] = 'http://ceen.et.byu.edu';//Link of your blog/Website homepage
    $config['orgname']  = 'Lakes of Utah'; //Name of your organization
