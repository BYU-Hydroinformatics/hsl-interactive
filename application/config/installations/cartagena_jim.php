<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['database_name']    = 'cartagena_jim2';
    ...
    */
    ...
    $config['default_source']   = 'BYU CEEn';
    $config['LocalX']   = 'NULL';
    $config['LocalY']   = 'NULL';
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'BYU CEEN'; //Name of your blog/Website homepage.
    $config['homelink'] = 'http://ceen.et.byu.edu/';//Link of your blog/Website homepage
    $config['orgname']  = 'BYU CEEn'; //Name of your organization
    ...
    */
    ...
    $config['auth_token'] = '';
    $config['service_code'] = 'cartagena_jim2';
    ...
    */
    ...
    /* End of file Cartagena_Jim.php */
    /* Location: ./application/config/installations/Cartagena_Jim.php */
