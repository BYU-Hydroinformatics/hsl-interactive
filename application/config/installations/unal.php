<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['homelink'] = 'www,unal.edu.co';//Link of your blog/Website homepage
    ...
    */
    ...
    /* End of file unal.php */
    /* Location: ./application/config/installations/unal.php */