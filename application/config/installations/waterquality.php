<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['database_name']    = 'waterquality';
    ...
    */
    ...
    $config['default_source']   = 'Water Quality';
    $config['LocalX']   = 'NULL';
    $config['LocalY']   = 'NULL';
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'water'; //Name of your blog/Website homepage.
    $config['homelink'] = 'www.byu.edu';//Link of your blog/Website homepage
    $config['orgname']  = 'Malheur Lake Water Quality'; //Name of your organization
    ...
    */
    ...
    $config['auth_token'] = '';
    $config['service_code'] = 'waterquality';
    ...
    */
    ...
    /* End of file waterquality.php */
    /* Location: ./application/config/installations/waterquality.php */