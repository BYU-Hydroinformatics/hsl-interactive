<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'BYU Bogota'; //Name of your blog/Website homepage.
    $config['homelink'] = 'www.byu.edu';//Link of your blog/Website homepage
    $config['orgname']  = 'Bogota'; //Name of your organization
    ...
    */
    ...
    /* End of file bogota.php */
    /* Location: ./application/config/installations/bogota.php */