<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['database_name']    = 'hydroinfo';
    ...
    */
    ...
    $config['homelink'] = 'BYU';//Link of your blog/Website homepage
    $config['orgname']  = 'Crowd Hydrology'; //Name of your organization
    ...
    */
    ...
    /* End of file hydroinfo.php */
    /* Location: ./application/config/installations/hydroinfo.php */