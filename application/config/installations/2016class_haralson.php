<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['database_name']    = '2016class_haralson';
    ...
    */
    ...
    $config['default_source']   = 'Civil & Environmental Engineering at the University of Utah';
    $config['LocalX']   = 'NULL';
    $config['LocalY']   = 'NULL';
    ...
    */
    ...
    $config['orgname']  = 'Civil & Environmental Engineering at the University of Utah'; //Name of your organization
    ...
    */
    ...
    $config['auth_token'] = '';
    $config['service_code'] = '2016class_haralson';
    ...
    */
    ...
    /* End of file 2016class_haralson.php */
    /* Location: ./application/config/installations/2016class_haralson.php */