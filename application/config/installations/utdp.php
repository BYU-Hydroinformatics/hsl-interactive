<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['default_source']   = 'Universidad Tecnologica de Pereira';
    $config['LocalX']   = 'NULL';
    $config['LocalY']   = 'NULL';
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'UTDP'; //Name of your blog/Website homepage.
    $config['homelink'] = 'www.universidadtecnologica.com';//Link of your blog/Website homepage
    $config['orgname']  = 'Universidad Tecnologica de Pereira'; //Name of your organization
    ...
    */
    ...
    /* End of file utdp.php */
    /* Location: ./application/config/installations/utdp.php */