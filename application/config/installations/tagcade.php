<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'Tagcade'; //Name of your blog/Website homepage.
    $config['homelink'] = 'Tagcade';//Link of your blog/Website homepage
    $config['orgname']  = 'Tagcade'; //Name of your organization
    ...
    */
    ...
    /* End of file tagcade.php */
    /* Location: ./application/config/installations/tagcade.php */