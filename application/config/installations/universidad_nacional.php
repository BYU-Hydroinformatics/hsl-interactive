<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['database_name']    = 'universidad_nacional';
    ...
    */
    ...
    $config['default_source']   = 'Universidad Nacional de Colombia';
    $config['LocalX']   = 'NULL';
    $config['LocalY']   = 'NULL';
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'unal'; //Name of your blog/Website homepage.
    $config['homelink'] = 'http://unal.edu.co';//Link of your blog/Website homepage
    $config['orgname']  = 'Universidad Nacional de Colombia'; //Name of your organization
    ...
    */
    ...
    $config['auth_token'] = '';
    $config['service_code'] = 'universidad_nacional';
    ...
    */
    ...
    /* End of file universidad_nacional.php */
    /* Location: ./application/config/installations/universidad_nacional.php */