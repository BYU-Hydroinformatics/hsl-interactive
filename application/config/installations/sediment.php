<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['default_source']   = 'Brigham Young University - Civil and Environmental Engineering Department';
    $config['LocalX']   = 'NULL';
    $config['LocalY']   = 'NULL';
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'BYU World Water Project'; //Name of your blog/Website homepage.
    $config['homelink'] = 'http://worldwater.byu.edu/';//Link of your blog/Website homepage
    $config['orgname']  = 'BYU Sediment Transport Database'; //Name of your organization
    ...
    */
    ...
    /* End of file sediment.php */
    /* Location: ./application/config/installations/sediment.php */