<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'snotel'; //Name of your blog/Website homepage.
    $config['homelink'] = 'snotel';//Link of your blog/Website homepage
    $config['orgname']  = 'snotel'; //Name of your organization
    ...
    */
    ...
    /* End of file snotel.php */
    /* Location: ./application/config/installations/snotel.php */