<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['database_name']    = 'rush_valley';
    ...
    */
    ...
    $config['default_source']   = 'BYU Gill Lab';
    $config['LocalX']   = 'NULL';
    $config['LocalY']   = 'NULL';
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'BYU Gill Lab'; //Name of your blog/Website homepage.
    $config['homelink'] = 'http://gilllab.byu.edu';//Link of your blog/Website homepage
    $config['orgname']  = 'Rush Valley'; //Name of your organization
