<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['database_name']    = 'amerigeoss';
    ...
    */
    ...
    $config['default_source']   = 'AmeriGEOSS';
    $config['LocalX']   = 'NULL';
    $config['LocalY']   = 'NULL';
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'Group on Earth Observations'; //Name of your blog/Website homepage.
    $config['homelink'] = 'www.earthobservations.org/';//Link of your blog/Website homepage
    $config['orgname']  = 'AmeriGEOSS'; //Name of your organization
    ...
    */
    ...
    $config['auth_token'] = '';
    $config['service_code'] = 'amerigeoss';
    ...
    */
    ...
    /* End of file amerigeoss.php */
    /* Location: ./application/config/installations/amerigeoss.php */