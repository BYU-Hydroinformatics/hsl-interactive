<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['default_source']   = 'Grupo de Investigaciones Ambientales';
    $config['LocalX']   = 'NULL';
    $config['LocalY']   = 'NULL';
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'GIA'; //Name of your blog/Website homepage.
    $config['homelink'] = 'www.upb.edu.co';//Link of your blog/Website homepage
    $config['orgname']  = 'Grupo de Investigaciones Ambientales'; //Name of your organization
    ...
    */
    ...
    /* End of file gia.php */
    /* Location: ./application/config/installations/gia.php */