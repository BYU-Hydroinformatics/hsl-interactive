<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['default_source']   = 'Climate Models';
    $config['LocalX']   = 'NULL';
    $config['LocalY']   = 'NULL';
    ...
    */
    ...
    $config['homelink'] = 'http://byu.edu';//Link of your blog/Website homepage
    $config['orgname']  = 'Climate Models'; //Name of your organization
    ...
    */
    ...
    /* End of file climate.php */
    /* Location: ./application/config/installations/climate.php */