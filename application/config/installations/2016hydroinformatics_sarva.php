<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['database_name']    = '2016hydroinformatics_sarva';
    ...
    */
    ...
    $config['default_source']   = 'Spice King';
    $config['LocalX']   = 'NULL';
    $config['LocalY']   = 'NULL';
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['default_varcode']  = 'BYU';
    $config['time_support'] = '8';
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'Spice King'; //Name of your blog/Website homepage.
    $config['homelink'] = 'www.byu.edu';//Link of your blog/Website homepage
    $config['orgname']  = 'Spice King'; //Name of your organization
    ...
    */
    ...
    $config['auth_token'] = '';
    $config['service_code'] = '2016hydroinformatics_sarva';
    ...
    */
    ...
    /* End of file 2016hydroinformatics_sarva.php */
    /* Location: ./application/config/installations/2016hydroinformatics_sarva.php */