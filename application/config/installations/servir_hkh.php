<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['database_name']    = 'servir_hkh';
    ...
    */
    ...
    $config['default_source']   = 'International Centre for Integrated Mountain Development';
    $config['LocalX']   = 'NULL';
    $config['LocalY']   = 'NULL';
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'ICIMOD'; //Name of your blog/Website homepage.
    $config['homelink'] = 'www.icimod.org';//Link of your blog/Website homepage
    $config['orgname']  = 'International Centre for Integrated Mountain Development'; //Name of your organization
    ...
    */
    ...
    $config['auth_token'] = '';
    $config['service_code'] = 'servir_hkh';
    ...
    */
    ...
    /* End of file servir_hkh.php */
    /* Location: ./application/config/installations/servir_hkh.php */