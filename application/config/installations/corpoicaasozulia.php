<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['database_name']    = 'corpoicaasozulia';
    ...
    */
    ...
    $config['default_source']   = 'Corpoica';
    $config['LocalX']   = 'NULL';
    $config['LocalY']   = 'NULL';
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'Corpoica'; //Name of your blog/Website homepage.
    $config['homelink'] = 'http://worldwater.byu.edu/';//Link of your blog/Website homepage
    $config['orgname']  = 'Corpoica'; //Name of your organization
    ...
    */
    ...
    $config['auth_token'] = '';
    $config['service_code'] = 'corpoicaasozulia';
    ...
    */
    ...
    /* End of file corpoicaasozulia.php */
    /* Location: ./application/config/installations/corpoicaasozulia.php */