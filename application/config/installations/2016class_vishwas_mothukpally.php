<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['database_name']    = '2016class_vishwas_mothukpally';
    ...
    */
    ...
    $config['default_source']   = '2016 Hydroinformatics Class';
    $config['LocalX']   = 'NULL';
    $config['LocalY']   = 'NULL';
    ...
    */
    ...
    $config['orgname']  = '2016 Hydroinformatics Class'; //Name of your organization
    ...
    */
    ...
    $config['auth_token'] = '';
    $config['service_code'] = '2016class_vishwas_mothukpally';
    ...
    */
    ...
    /* End of file 2016class_vishwas_mothukpally.php */
    /* Location: ./application/config/installations/2016class_vishwas_mothukpally.php */