<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'INETER'; //Name of your blog/Website homepage.
    $config['homelink'] = 'http://www.ineter.gob.ni/';//Link of your blog/Website homepage
    $config['orgname']  = 'INETER (Nicaragua)'; //Name of your organization
