...
$config['database_name']     = 'hotchkiss';
$config['database_password'] = 'dbWWAdmin@999';
/*
|--------------------------------------------------------------------------
...
$config['default_source']    = 'BYU Civil Engineering Department';
$config['LocalX']            = 'NULL';
$config['LocalY']            = 'NULL';
$config['LocalProjectionID'] = 'NULL';
$config['PosAccuracy_m']     = '10';
/*
|--------------------------------------------------------------------------
...
|--------------------------------------------------------------------------
 */
$config['homename']   = 'BYU World Water'; //Name of your blog/Website homepage.
$config['homelink']   = 'http://worldwater.byu.edu/'; //Link of your blog/Website homepage
$config['orgname']    = 'Sediment Transport Data'; //Name of your organization
