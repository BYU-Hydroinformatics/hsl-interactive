<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['default_source']   = 'CONRED';
    $config['LocalX']   = '-90.52327';
    $config['LocalY']   = '14.586831';
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'CONRED'; //Name of your blog/Website homepage.
    $config['homelink'] = 'http://conred.gob.gt';//Link of your blog/Website homepage
    $config['orgname']  = 'CONRED (Guatemala)'; //Name of your organization
