<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['database_name']    = '2016class_huaxin';
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = '2016 Hydroindormatics Class'; //Name of your blog/Website homepage.
    ...
    */
    ...
    $config['auth_token'] = '';
    $config['service_code'] = '2016class_huaxin';
    ...
    */
    ...
    /* End of file 2016class_huaxin.php */
    /* Location: ./application/config/installations/2016class_huaxin.php */