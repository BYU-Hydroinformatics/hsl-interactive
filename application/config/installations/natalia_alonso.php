<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['database_name']    = 'natalia_alonso';
    ...
    */
    ...
    $config['auth_token'] = '';
    $config['service_code'] = 'natalia_alonso';
    ...
    */
    ...
    /* End of file natalia_alonso.php */
    /* Location: ./application/config/installations/natalia_alonso.php */