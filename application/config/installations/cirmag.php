<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'IDEAM'; //Name of your blog/Website homepage.
    $config['homelink'] = 'http://www.ideam.gov.co/';//Link of your blog/Website homepage
    $config['orgname']  = 'CIRMAG'; //Name of your organization
    ...
    */
    ...
    /* End of file cirmag.php */
    /* Location: ./application/config/installations/cirmag.php */