<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['default_varcode']  = 'DateTime';
    ...
    */
    ...
    $config['orgname']  = 'USU'; //Name of your organization
    ...
    */
    ...
    /* End of file khafen.php */
    /* Location: ./application/config/installations/khafen.php */