<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['database_name']    = '2016class_richard';
    ...
    */
    ...
    $config['default_source']   = 'Hydroinformatics';
    $config['LocalX']   = 'NULL';
    $config['LocalY']   = 'NULL';
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'Hydro'; //Name of your blog/Website homepage.
    $config['homelink'] = 'https://usu.instructure.com/courses/417249 ';//Link of your blog/Website homepage
    $config['orgname']  = 'Hydroinformatics'; //Name of your organization
    ...
    */
    ...
    $config['auth_token'] = '';
    $config['service_code'] = '2016class_richard';
    ...
    */
    ...
    /* End of file 2016class_richard.php */
    /* Location: ./application/config/installations/2016class_richard.php */