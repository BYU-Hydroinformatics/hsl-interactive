<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['database_name']    = 'hydroinformatics2016_haralson';
    ...
    */
    ...
    $config['default_source']   = 'University of Utah Civil and Environmental Engineering';
    $config['LocalX']   = 'NULL';
    $config['LocalY']   = 'NULL';
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['default_varcode']  = 'UOFU-CVEN';
    $config['time_support'] = '15';
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'Civil & Environmental Engineering at the University of Utah'; //Name of your blog/Website homepage.
    $config['homelink'] = 'http://www.civil.utah.edu/';//Link of your blog/Website homepage
    $config['orgname']  = 'University of Utah Civil and Environmental Engineering'; //Name of your organization
    ...
    */
    ...
    $config['auth_token'] = '';
    $config['service_code'] = 'hydroinformatics2016_haralson';
    ...
    */
    ...
    /* End of file hydroinformatics2016_haralson.php */
    /* Location: ./application/config/installations/hydroinformatics2016_haralson.php */