<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['database_name']    = '2016class_chaney';
    ...
    */
    ...
    $config['auth_token'] = '';
    $config['service_code'] = '2016class_chaney';
    ...
    */
    ...
    /* End of file 2016class_chaney.php */
    /* Location: ./application/config/installations/2016class_chaney.php */