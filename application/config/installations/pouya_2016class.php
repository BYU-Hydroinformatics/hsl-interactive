<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['database_name']    = 'pouya_2016class';
    ...
    */
    ...
    $config['auth_token'] = '';
    $config['service_code'] = 'pouya_2016class';
    ...
    */
    ...
    /* End of file pouya_2016class.php */
    /* Location: ./application/config/installations/pouya_2016class.php */