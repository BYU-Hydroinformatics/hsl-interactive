<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['default_varcode']  = 'ICIMOD';
    $config['time_support'] = '7';
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'International Centre for Integrated Mountain Development'; //Name of your blog/Website homepage.
    $config['homelink'] = 'http://www.icimod.org/';//Link of your blog/Website homepage
    $config['orgname']  = 'ICIMOD'; //Name of your organization
    ...
    */
    ...
    /* End of file icimod.php */
    /* Location: ./application/config/installations/icimod.php */