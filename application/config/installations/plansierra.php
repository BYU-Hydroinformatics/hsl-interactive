<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['database_name']    = 'plansierra';
    ...
    */
    ...
    $config['default_source']   = 'Plan Sierra';
    $config['LocalX']   = 'NULL';
    $config['LocalY']   = 'NULL';
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'Plan Sierra'; //Name of your blog/Website homepage.
    $config['homelink'] = 'http://plan.plansierra.org.do/';//Link of your blog/Website homepage
    $config['orgname']  = 'Plan Sierra'; //Name of your organization
    ...
    */
    ...
    $config['auth_token'] = '';
    $config['service_code'] = 'plansierra';
    ...
    */
    ...
    /* End of file plansierra.php */
    /* Location: ./application/config/installations/plansierra.php */