<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['database_name']    = 'argentina';
    ...
    */
    ...
    $config['default_source']   = 'Servicio Meteorologica de Argentina';
    $config['LocalX']   = 'NULL';
    $config['LocalY']   = 'NULL';
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'SMN'; //Name of your blog/Website homepage.
    $config['homelink'] = 'www.smn.gov.ar';//Link of your blog/Website homepage
    $config['orgname']  = 'Servicio Meteorologica de Argentina'; //Name of your organization
    ...
    */
    ...
    /* End of file argentina.php */
    /* Location: ./application/config/installations/argentina.php */