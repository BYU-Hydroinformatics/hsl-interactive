<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['database_name']    = '2016class';
    ...
    */
    ...
    $config['default_source']   = 'Hydroinformatics 2016 Class';
    $config['LocalX']   = 'NULL';
    $config['LocalY']   = 'NULL';
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'www.byu.edu'; //Name of your blog/Website homepage.
    $config['homelink'] = 'www.byu.edu';//Link of your blog/Website homepage
    $config['orgname']  = 'Hydroinformatics 2016 Class'; //Name of your organization
    ...
    */
    ...
    /* End of file 2016class.php */
    /* Location: ./application/config/installations/2016class.php */