<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['default_source']   = 'Ministerio de Ambiente y Desarrollo Sostenible';
    $config['LocalX']   = 'NULL';
    $config['LocalY']   = 'NULL';
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'MADS'; //Name of your blog/Website homepage.
    $config['homelink'] = 'www.minambiente.gov.co';//Link of your blog/Website homepage
    $config['orgname']  = 'Ministerio de Ambiente y Desarrollo Sostenible'; //Name of your organization
    ...
    */
    ...
    /* Location: ./application/config/installations/mads.php */