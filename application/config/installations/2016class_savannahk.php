<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['database_name']    = '2016class_savannahk';
    ...
    */
    ...
    $config['auth_token'] = '';
    $config['service_code'] = '2016class_savannahk';
    ...
    */
    ...
    /* End of file 2016class_savannahk.php */
    /* Location: ./application/config/installations/2016class_savannahk.php */