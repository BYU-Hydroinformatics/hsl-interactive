<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['database_name']    = '2016hydroinformatics_erice';
    ...
    */
    ...
    $config['default_source']   = '2016Hydroinformatics_erice';
    $config['LocalX']   = 'NULL';
    $config['LocalY']   = 'NULL';
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['default_varcode']  = 'CE534';
    $config['time_support'] = '40.2';
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'World Water Project'; //Name of your blog/Website homepage.
    $config['homelink'] = 'worldwater.byu.edu';//Link of your blog/Website homepage
    $config['orgname']  = '2016Hydroinformatics_erice'; //Name of your organization
    ...
    */
    ...
    $config['auth_token'] = '';
    $config['service_code'] = '2016hydroinformatics_erice';
    ...
    */
    ...
    /* End of file 2016hydroinformatics_erice.php */
    /* Location: ./application/config/installations/2016hydroinformatics_erice.php */