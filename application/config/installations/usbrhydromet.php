<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    */
    ...
    $config['database_name']    = 'usbrhydromet';
    ...
    */
    ...
    $config['default_source']   = 'USBR Hydromet';
    $config['LocalX']   = 'NULL';
    $config['LocalY']   = 'NULL';
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    $config['homename'] = 'Hydromet'; //Name of your blog/Website homepage.
    $config['homelink'] = 'http://www.usbr.gov/pn/hydromet/';//Link of your blog/Website homepage
    $config['orgname']  = 'USBR Hydromet'; //Name of your organization
    ...
    */
    ...
    $config['auth_token'] = '';
    $config['service_code'] = 'usbrhydromet';
    ...
    */
    ...
    /* End of file usbrhydromet.php */
    /* Location: ./application/config/installations/usbrhydromet.php */